...
def main():
    background_layout = [
        title_bar(
            'This is the titlebar', sg.theme_text_color(), sg.theme_background_color()
        ),
    ...
    column1 = [
        ...
        [
            sg.Spin(
                values=('Spin Box 1', 'Spin Box 2', 'Spin Box 3'),
    ...
    layout = [
        ...
        [
            sg.Frame(
                layout=[
                    ...
                    [
                        sg.Radio(
                            'My first Radio!     ', "RADIO1", default=True, size=(10, 1)
                        ),
        ...
        [
            sg.Combo(
                ('Combobox 1', 'Combobox 2'), default_value='Combobox 1', size=(20, 1)
            ),
    ...
    while True:
        ...
        filename = os.path.join(
            os.path.dirname(__file__), '/sources/', 'background_image.png'
        )

        filename = 'E:\IT_Learning\Python_Stuff\pdf2images\sources\background_image.jpg'
        # print(os.path.dirname(__file__), '/someting')
        print(filename + "&&&")
...
if __name__ == '__main__':
    # with open('./sources/background_image.jpg', 'rb') as f:
    #     iamge_base64 = base64.b64encode(f.read())
    #     # print(iamge_base64)
    #     background_image = b'{iamge_base64}'
    #     main()

    #     with open('./sources/base64.txt', 'wb') as f:
    #         f.write(iamge_base64)
